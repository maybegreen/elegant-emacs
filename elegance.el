...
(setq default-frame-alist
      (append (list '(width  . 72) '(height . 20)
...
(defun set-modeline-faces ()
  ...
  (set-face 'header-line-highlight nil)
  ...
  (set-face 'mode-line-inactive nil)
  ...
  (set-face-attribute 'cursor nil
                      ...
                      :background "#b20525")
  (set-face 'window-divider 'face-faded)
...
(defun elegance-dark ()
  ...
  (set-face-attribute 'default nil
                      :foreground (face-foreground 'default)
                      :background (face-background 'default))
  (set-face-attribute 'face-critical nil :foreground "#ff5f38"
                      :background "#581823")
  ...
  (set-face-attribute 'face-salient nil :foreground "#dca3a3"
                      :background "#000000"
                      :weight 'light)
  (set-face-attribute 'face-faded nil :foreground "#775757"
                      :weight 'light)
  (set-face-attribute 'face-subtle nil :background "#000025")
  (set-modeline-faces)
  (with-eval-after-load 'cus-edit (set-button-faces)))
